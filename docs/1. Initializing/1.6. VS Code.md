...
- [**astral-sh.ty**](https://marketplace.visualstudio.com/items?itemName=astral-sh.ty): the official extension for `ty`, Astral's extremely fast Python type checker and language server. Great to validate your typing as you code.
