...
services:
  mlflow:
    ...
    ports:
      - 5000:5000
    environment:
      # MLflow 3 puts the filesystem store in maintenance mode; opt in for local development.
...
# In production, prefer a database backend such as "sqlite:///mlflow.db".
