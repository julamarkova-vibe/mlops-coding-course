---
description: Master code formatting with tools like Ruff and dprint to enhance readability, maintainability, and consistency across your Python code and configuration files. Learn how to use automated formatting tools to enforce PEP 8 standards and optimize your code for collaboration.
---
...
```json
{
	...
	"lineWidth": 120,
	"excludes": ["**/*-lock.json", "**/node_modules", ".git", ".venv"],
	"markdown": {
		"textWrap": "never"
	},
	"plugins": [
