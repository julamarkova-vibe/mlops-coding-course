...
You can apply this ruleset manually through the GitHub UI or automate it with a [mise task](https://github.com/fmind/mlops-python-package/blob/main/mise.toml), run with `mise run install:rulesets`:
